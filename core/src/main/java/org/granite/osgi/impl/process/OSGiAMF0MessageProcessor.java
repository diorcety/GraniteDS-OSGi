 ...
 * @author Franck WOLFF
 */
public abstract class OSGiAMF0MessageProcessor {

    private static final Logger log = Logger.getLogger(OSGiAMF0MessageProcessor.class);
    ...
    public static AMF0Message process(AMF0Message amf0RequestMessage) {
        ...
        for (Iterator<AMF0Body> bodies = amf0RequestMessage.getBodies(); bodies.hasNext(); ) {
            ...
            if (loginError == null) {
                ...
                amf3ResponseMessage = OSGiAMF3MessageProcessor.process(amf3RequestMessage);
